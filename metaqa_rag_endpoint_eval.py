...
OUTPUT_PATH = os.path.join(BASE_DIR, "results", "metaqa_llama3b_RAG_endpoint.jsonl")

RAG_MODEL_NAME = "metaqa"
...
def call_rag_endpoint(question_text: str) -> Dict[str, Any]:
    payload = {
        "model": RAG_MODEL_NAME,
        "prompt": build_rag_prompt(question_text),
    }
...
def main():
    ...
    for idx, sample in enumerate(dataset, start=1):
        ...
        res = call_rag_endpoint(question)
    ...
    print("[DONE] RAG endpoint evaluation complete.")
